...
Vanilla JS (ES6+) без фреймворков и бандлеров. ~86 модулей, загружаемых через `<script>` теги в шаблонах.

**Shared (`static/js/shared/` — 8 файлов):**
...
**Constructor (`static/js/constructor/` — 41 файл):**
