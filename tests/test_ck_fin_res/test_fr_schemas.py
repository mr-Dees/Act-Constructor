...
class TestFRValidationCreate:
    ...
    def test_minimal_fields(self):
        ...
        assert record.mpl_amount_rubles == Decimal("0")
    ...
    def test_full_fields(self):
        ...
        record = FRValidationCreate(
            ...
            mpl_amount_rubles=Decimal("50.00"),
            ...
            block_owner="Кредитование",
            department_owner="Департамент кредитования ЮЛ",
        ...
        assert record.mpl_amount_rubles == Decimal("50.00")
