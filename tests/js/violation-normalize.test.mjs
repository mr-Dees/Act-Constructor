...
test('нарушение без recommendations → до-заполнено эталоном, форма не падает', () => {
    const violations = {
        v1: {
            id: 'v1',
            nodeId: 'n1',
            ...
            // recommendations отсутствует целиком (старый/повреждённый акт)
        },
    };
    ...
    assert.deepEqual(violations.v1.recommendations, { enabled: false, content: '' });
});
