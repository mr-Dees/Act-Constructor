...
COMMENT ON TABLE {REF_METRIC_DICT} IS 'Справочник метрик нарушений';

-- Заполняем тестовыми данными
INSERT INTO {REF_METRIC_DICT} (code, metric_name, metric_group) VALUES
...
COMMENT ON TABLE {REF_PROCESS_DICT} IS 'Справочник процессов аудита';

INSERT INTO {REF_PROCESS_DICT} (process_code, process_name) VALUES
...
COMMENT ON TABLE {REF_SUBSIDIARY_DICT} IS 'Справочник подразделений профиля';

INSERT INTO {REF_SUBSIDIARY_DICT} (name) VALUES
