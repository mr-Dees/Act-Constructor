    ...
    return [
        ...
        ChatTool(
            ...
            parameters=[
                ...
                ChatToolParam("created_date_from", "date", "Дата составления от (формат YYYY-MM-DD)", required=False),
                ChatToolParam("created_date_to", "date", "Дата составления до (YYYY-MM-DD)", required=False),
                ChatToolParam("order_date_from", "date", "Дата приказа от (YYYY-MM-DD)", required=False),
                ChatToolParam("order_date_to", "date", "Дата приказа до (YYYY-MM-DD)", required=False),
                ChatToolParam("inspection_start_from", "date", "Начало проверки от (YYYY-MM-DD)", required=False),
                ChatToolParam("inspection_start_to", "date", "Начало проверки до (YYYY-MM-DD)", required=False),
                ChatToolParam("inspection_end_from", "date", "Окончание проверки от (YYYY-MM-DD)", required=False),
                ChatToolParam("inspection_end_to", "date", "Окончание проверки до (YYYY-MM-DD)", required=False),
