...
from app.domains.acts.integrations.ai_assistant.export_search import search_acts

from app.domains.acts.integrations.ai_assistant.export_structure import (
    get_act_structure,
    get_act_structures_batch,
)

from app.domains.acts.integrations.ai_assistant.export_acts import (
    get_act_by_km,
    get_acts_by_km_list,
)

from app.domains.acts.integrations.ai_assistant.export_items import (
    get_item_by_number,
    get_items_by_number_list,
)

from app.domains.acts.integrations.ai_assistant.export_violations import (
    get_all_violations,
...
from app.domains.acts.integrations.ai_assistant.export_tables import (
    get_all_tables,
...
from app.domains.acts.integrations.ai_assistant.export_textblocks import (
    get_all_textblocks,
...
from app.domains.acts.integrations.ai_assistant.export_invoices import (
    get_all_invoices,
