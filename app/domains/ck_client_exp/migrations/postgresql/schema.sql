...
INSERT INTO t_db_oarb_ck_cs_validation (
    act_sub_number_id, reestr_metric_id, neg_finder_tb_id, metric_code, metric_name,
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 36-мо0255' LIMIT 1), NULL, '14', '1001', 'Несоблюдение лимитов кредитования', 25, 30, 500000.00, true,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 36-мо0255' LIMIT 1), NULL, '7', '1002', 'Нарушение порядка оценки залога', 12, 18, 240500.50, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 36-мо0255' LIMIT 1), NULL, '8', '1003', 'Некорректное определение категории качества', 40, 55, 1250000.00, true,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 36-мо0255' LIMIT 1), NULL, '1', '1004', 'Нарушение порядка формирования резервов', 8, 10, 90000.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 36-мо0255' LIMIT 1), NULL, '4', '1001', 'Несоблюдение лимитов кредитования', 33, 41, 780000.75, true,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 36-мо0255' LIMIT 1), NULL, '14', '1002', 'Нарушение порядка оценки залога', 6, 9, 150000.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 36-мо0255' LIMIT 1), NULL, '7', '1003', 'Некорректное определение категории качества', 21, 27, 460000.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 36-мо0255' LIMIT 1), NULL, '8', '1004', 'Нарушение порядка формирования резервов', 14, 16, 0.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 36-мо0255' LIMIT 1), NULL, '14', '1001', 'Несоблюдение лимитов кредитования', 50, 60, 2100000.00, true,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 36-мо0255' LIMIT 1), NULL, '1', '1002', 'Нарушение порядка оценки залога', 9, 11, 320000.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 36-мо0255' LIMIT 1), NULL, '4', '1003', 'Некорректное определение категории качества', 27, 35, 640000.00, true,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 36-мо0255' LIMIT 1), NULL, '7', '1004', 'Нарушение порядка формирования резервов', 3, 5, 55000.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'МСК 12-мо0100' LIMIT 1), NULL, '7', '1001', 'Несоблюдение лимитов кредитования', 18, 22, 410000.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'МСК 12-мо0100' LIMIT 1), NULL, '8', '1002', 'Нарушение порядка оценки залога', 11, 14, 205000.25, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'МСК 12-мо0100' LIMIT 1), NULL, '14', '1003', 'Некорректное определение категории качества', 36, 48, 980000.00, true,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'МСК 12-мо0100' LIMIT 1), NULL, '1', '1004', 'Нарушение порядка формирования резервов', 7, 9, 72000.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'МСК 12-мо0100' LIMIT 1), NULL, '4', '1001', 'Несоблюдение лимитов кредитования', 29, 34, 690000.50, true,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'МСК 12-мо0100' LIMIT 1), NULL, '7', '1002', 'Нарушение порядка оценки залога', 5, 7, 130000.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'МСК 12-мо0100' LIMIT 1), NULL, '8', '1003', 'Некорректное определение категории качества', 24, 31, 520000.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'МСК 12-мо0100' LIMIT 1), NULL, '14', '1004', 'Нарушение порядка формирования резервов', 16, 19, 88000.00, true,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'МСК 12-мо0100' LIMIT 1), NULL, '1', '1001', 'Несоблюдение лимитов кредитования', 44, 52, 1750000.00, true,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'МСК 12-мо0100' LIMIT 1), NULL, '4', '1002', 'Нарушение порядка оценки залога', 8, 10, 275000.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'МСК 12-мо0100' LIMIT 1), NULL, '7', '1003', 'Некорректное определение категории качества', 22, 28, 445000.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'МСК 12-мо0100' LIMIT 1), NULL, '8', '1004', 'Нарушение порядка формирования резервов', 4, 6, 61000.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 50-мо0300' LIMIT 1), NULL, '14', '1001', 'Несоблюдение лимитов кредитования', 30, 38, 850000.00, true,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 50-мо0300' LIMIT 1), NULL, '7', '1002', 'Нарушение порядка оценки залога', 13, 17, 260000.75, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 50-мо0300' LIMIT 1), NULL, '8', '1003', 'Некорректное определение категории качества', 47, 61, 1350000.00, true,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 50-мо0300' LIMIT 1), NULL, '1', '1004', 'Нарушение порядка формирования резервов', 6, 8, 68000.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 50-мо0300' LIMIT 1), NULL, '4', '1001', 'Несоблюдение лимитов кредитования', 35, 43, 720000.25, true,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 50-мо0300' LIMIT 1), NULL, '14', '1002', 'Нарушение порядка оценки залога', 9, 12, 175000.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 50-мо0300' LIMIT 1), NULL, '7', '1003', 'Некорректное определение категории качества', 26, 33, 500000.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 50-мо0300' LIMIT 1), NULL, '8', '1004', 'Нарушение порядка формирования резервов', 15, 18, 95000.00, true,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 50-мо0300' LIMIT 1), NULL, '14', '1001', 'Несоблюдение лимитов кредитования', 52, 64, 2300000.00, true,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 50-мо0300' LIMIT 1), NULL, '1', '1002', 'Нарушение порядка оценки залога', 10, 13, 300000.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 50-мо0300' LIMIT 1), NULL, '4', '1003', 'Некорректное определение категории качества', 23, 29, 470000.00, false,
...
INSERT INTO t_db_oarb_ck_cs_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 50-мо0300' LIMIT 1), NULL, '7', '1004', 'Нарушение порядка формирования резервов', 4, 6, 58000.00, false,
