...
-- 37. Демо-группа NPL 90+ (метрика 602) на п. 5.2.1, суб-акт ЦА 36-мо0255, ТБ Московский
INSERT INTO t_db_oarb_ck_fr_validation (
    act_sub_number_id, reestr_metric_id, application_status, neg_finder_tb_id, metric_code, metric_name, metric_element_counts, metric_amount_rubles, npl_amount_rubles, is_sent_to_top_brass, km_id, num_sz, dt_sz, act_item_number, process_number, process_name, deviation_description, deviation_reason, deviation_consequence, real_loss, ck_comment, pocket, risk, rev_start_dt, rev_end_dt, block_owner, department_owner, sberdocs_ctrl_assgn_number, assigment_id, assigment_format, inspection_name, assigment_recommendation, execution_deadline, used_pm_lib, etl_loading_id, row_hash, applied_into_ua, created_by
) SELECT
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 36-мо0255' LIMIT 1), NULL, 'На рассмотрении', '7', '602', 'NPL 90+ (просроченная задолженность свыше 90 дней)', 2, 300000.00, 120000.00, false, 'КМ-09-41726', '255', '2025-02-06', '5.2.1', 'П6210', 'Операции на финансовых рынках', 'Некорректный расчёт финансовых показателей по кредитному портфелю ЮЛ', 'Ошибки в исходных данных по сделкам', 'Завышение прибыли по кредитному портфелю', false, 'Требуется доработка процедуры: методики расчёта показателей', 'Корпоративная', 'Кредитный риск B2B', '2024-08-01 00:00:00', '2025-02-01 00:00:00', 'Финансы', 'Казначейство', 'SD-2025-00256', 1002, 'Самостоятельный контроль', 'Проверка методики расчёта показателей (ЦА 2025)', 'Усилить контроль: методики расчёта показателей', '2025-07-28 00:00:00', 'Нет', NULL, 'frh37602npl1', false, 'system'
...
INSERT INTO t_db_oarb_ck_fr_validation (
    ...
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 36-мо0255' LIMIT 1), NULL, 'На рассмотрении', '8', '602', 'NPL 90+ (просроченная задолженность свыше 90 дней)', 1, 150000.00, 80000.00, false, 'КМ-09-41726', '255', '2025-02-06', '5.2.1', 'П6210', 'Операции на финансовых рынках', 'Некорректный расчёт финансовых показателей по кредитному портфелю ЮЛ', 'Ошибки в исходных данных по сделкам', 'Завышение прибыли по кредитному портфелю', false, 'Требуется доработка процедуры: методики расчёта показателей', 'Корпоративная', 'Кредитный риск B2B', '2024-08-01 00:00:00', '2025-02-01 00:00:00', 'Финансы', 'Казначейство', 'SD-2025-00256', 1002, 'Самостоятельный контроль', 'Проверка методики расчёта показателей (ЦА 2025)', 'Усилить контроль: методики расчёта показателей', '2025-07-28 00:00:00', 'Нет', NULL, 'frh37602npl2', false, 'system'
