...
CREATE TABLE IF NOT EXISTS t_db_oarb_ck_fr_validation (
    ...
    mpl_amount_rubles NUMERIC(38, 2) DEFAULT 0, -- MPL 90+, руб. (заполняется только для метрики 602)
...
-- 14а. Та же метрика 2002 на п. 5.1.1 (КМ-07-30001), выявлена Московским банком (вторая multi-ТБ группа)
INSERT INTO t_db_oarb_ck_fr_validation (
    act_sub_number_id, reestr_metric_id, application_status, neg_finder_tb_id, metric_code, metric_name, metric_element_counts, metric_amount_rubles, is_sent_to_top_brass, km_id, num_sz, dt_sz, act_item_number, process_number, process_name, deviation_description, deviation_reason, deviation_consequence, real_loss, ck_comment, pocket, risk, rev_start_dt, rev_end_dt, block_owner, department_owner, sberdocs_ctrl_assgn_number, assigment_id, assigment_format, inspection_name, assigment_recommendation, execution_deadline, used_pm_lib, etl_loading_id, row_hash, applied_into_ua, created_by
) SELECT
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'МСК 12-мо0100' LIMIT 1), NULL, 'На рассмотрении', '7', '2002', 'Некорректный расчет финансовых показателей', 6, 98000.00, false, 'КМ-07-30001', '100', '2025-02-18', '5.1.1', 'П6210', 'Операции на финансовых рынках', 'Некорректный расчёт финансовых показателей по кредитному портфелю ЮЛ', 'Ошибки в исходных данных по сделкам', 'Завышение прибыли по кредитному портфелю', false, 'Требуется доработка процедуры: методики расчёта показателей', 'Корпоративная', 'Кредитный риск B2B', '2024-10-01 00:00:00', '2025-04-01 00:00:00', 'Финансы', 'Казначейство', 'SD-2025-00113', 1014, 'Самостоятельный контроль', 'Проверка методики расчёта показателей (МСК 2025)', 'Усилить контроль: методики расчёта показателей', '2025-07-28 00:00:00', 'Нет', NULL, 'frh132002518', false, 'system'
WHERE NOT EXISTS (SELECT 1 FROM t_db_oarb_ck_fr_validation WHERE km_id = 'КМ-07-30001' AND act_item_number = '5.1.1' AND metric_code = '2002' AND neg_finder_tb_id = '7');

-- 26а. Та же метрика 2002 на п. 5.1.1 (КМ-14-50001), выявлена Поволжским банком (третья multi-ТБ группа)
INSERT INTO t_db_oarb_ck_fr_validation (
    act_sub_number_id, reestr_metric_id, application_status, neg_finder_tb_id, metric_code, metric_name, metric_element_counts, metric_amount_rubles, is_sent_to_top_brass, km_id, num_sz, dt_sz, act_item_number, process_number, process_name, deviation_description, deviation_reason, deviation_consequence, real_loss, ck_comment, pocket, risk, rev_start_dt, rev_end_dt, block_owner, department_owner, sberdocs_ctrl_assgn_number, assigment_id, assigment_format, inspection_name, assigment_recommendation, execution_deadline, used_pm_lib, etl_loading_id, row_hash, applied_into_ua, created_by
) SELECT
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 50-мо0300' LIMIT 1), NULL, 'На рассмотрении', '8', '2002', 'Некорректный расчет финансовых показателей', 4, 127000.00, false, 'КМ-14-50001', '300', '2025-02-10', '5.1.1', 'П6210', 'Операции на финансовых рынках', 'Некорректный расчёт финансовых показателей по кредитному портфелю ЮЛ', 'Ошибки в исходных данных по сделкам', 'Завышение прибыли по кредитному портфелю', false, 'Требуется доработка процедуры: методики расчёта показателей', 'Корпоративная', 'Кредитный риск B2B', '2024-07-01 00:00:00', '2025-01-01 00:00:00', 'Финансы', 'Казначейство', 'SD-2025-00325', 1026, 'Самостоятельный контроль', 'Проверка методики расчёта показателей (ЦА 2025)', 'Усилить контроль: методики расчёта показателей', '2025-07-28 00:00:00', 'Нет', NULL, 'frh252002518', true, 'system'
WHERE NOT EXISTS (SELECT 1 FROM t_db_oarb_ck_fr_validation WHERE km_id = 'КМ-14-50001' AND act_item_number = '5.1.1' AND metric_code = '2002' AND neg_finder_tb_id = '8');

-- 37. Демо-группа MPL 90+ (метрика 602) на п. 5.2.1, суб-акт ЦА 36-мо0255, ТБ Московский
INSERT INTO t_db_oarb_ck_fr_validation (
    act_sub_number_id, reestr_metric_id, application_status, neg_finder_tb_id, metric_code, metric_name, metric_element_counts, metric_amount_rubles, mpl_amount_rubles, is_sent_to_top_brass, km_id, num_sz, dt_sz, act_item_number, process_number, process_name, deviation_description, deviation_reason, deviation_consequence, real_loss, ck_comment, pocket, risk, rev_start_dt, rev_end_dt, block_owner, department_owner, sberdocs_ctrl_assgn_number, assigment_id, assigment_format, inspection_name, assigment_recommendation, execution_deadline, used_pm_lib, etl_loading_id, row_hash, applied_into_ua, created_by
) SELECT
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 36-мо0255' LIMIT 1), NULL, 'На рассмотрении', '7', '602', 'MPL 90+ (просроченная задолженность свыше 90 дней)', 2, 300000.00, 120000.00, false, 'КМ-09-41726', '255', '2025-02-06', '5.2.1', 'П6210', 'Операции на финансовых рынках', 'Некорректный расчёт финансовых показателей по кредитному портфелю ЮЛ', 'Ошибки в исходных данных по сделкам', 'Завышение прибыли по кредитному портфелю', false, 'Требуется доработка процедуры: методики расчёта показателей', 'Корпоративная', 'Кредитный риск B2B', '2024-08-01 00:00:00', '2025-02-01 00:00:00', 'Финансы', 'Казначейство', 'SD-2025-00256', 1002, 'Самостоятельный контроль', 'Проверка методики расчёта показателей (ЦА 2025)', 'Усилить контроль: методики расчёта показателей', '2025-07-28 00:00:00', 'Нет', NULL, 'frh37602mpl1', false, 'system'
WHERE NOT EXISTS (SELECT 1 FROM t_db_oarb_ck_fr_validation WHERE km_id = 'КМ-09-41726' AND act_item_number = '5.2.1' AND metric_code = '602' AND neg_finder_tb_id = '7');

-- 37а. Та же метрика 602 на п. 5.2.1, выявлена Поволжским банком
INSERT INTO t_db_oarb_ck_fr_validation (
    act_sub_number_id, reestr_metric_id, application_status, neg_finder_tb_id, metric_code, metric_name, metric_element_counts, metric_amount_rubles, mpl_amount_rubles, is_sent_to_top_brass, km_id, num_sz, dt_sz, act_item_number, process_number, process_name, deviation_description, deviation_reason, deviation_consequence, real_loss, ck_comment, pocket, risk, rev_start_dt, rev_end_dt, block_owner, department_owner, sberdocs_ctrl_assgn_number, assigment_id, assigment_format, inspection_name, assigment_recommendation, execution_deadline, used_pm_lib, etl_loading_id, row_hash, applied_into_ua, created_by
) SELECT
    (SELECT id FROM t_db_oarb_ua_sub_number WHERE act_sub_number = 'ЦА 36-мо0255' LIMIT 1), NULL, 'На рассмотрении', '8', '602', 'MPL 90+ (просроченная задолженность свыше 90 дней)', 1, 150000.00, 80000.00, false, 'КМ-09-41726', '255', '2025-02-06', '5.2.1', 'П6210', 'Операции на финансовых рынках', 'Некорректный расчёт финансовых показателей по кредитному портфелю ЮЛ', 'Ошибки в исходных данных по сделкам', 'Завышение прибыли по кредитному портфелю', false, 'Требуется доработка процедуры: методики расчёта показателей', 'Корпоративная', 'Кредитный риск B2B', '2024-08-01 00:00:00', '2025-02-01 00:00:00', 'Финансы', 'Казначейство', 'SD-2025-00256', 1002, 'Самостоятельный контроль', 'Проверка методики расчёта показателей (ЦА 2025)', 'Усилить контроль: методики расчёта показателей', '2025-07-28 00:00:00', 'Нет', NULL, 'frh37602mpl2', false, 'system'
WHERE NOT EXISTS (SELECT 1 FROM t_db_oarb_ck_fr_validation WHERE km_id = 'КМ-09-41726' AND act_item_number = '5.2.1' AND metric_code = '602' AND neg_finder_tb_id = '8');
